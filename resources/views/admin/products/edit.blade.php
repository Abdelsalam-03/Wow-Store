    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg d-flex flex-column gap-3">
                <form action="{{route('admin.products.update', ['product' => $product->id])}}" method="POST" class="d-flex flex-column gap-3">
                    @csrf
                    @method('PUT')
                    <div>
                    ...
                    <div class="d-flex flex-column">
                        <p>Current Photo</p>
                        <img src="{{$product->photo ? asset('storage/' . $product->photo) : ''}}" alt="image" class="rounded" style="max-width: 250px">
                    </div>
                    <div>
